...
_dataset = 'myd11a1d'
_f = 'data/MYD11A1.006_1km_aid0001.nc'
_output = 'outputs/myd11a1d_processed.nc'
_lookup = 'data/lst/MYD11A1-006-QC-Day-lookup.csv'
_var = 'lst'
_datavar = 'LST_Day_1km'
_qcvar = 'QC_Day'
_fillvalue = 0
_discard_vars = ['LST_Night_1km', 'QC_Night']
