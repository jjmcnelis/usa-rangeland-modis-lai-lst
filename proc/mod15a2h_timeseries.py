...
_dataset = 'mod15a2h'
_f = 'data/MOD15A2H.006_500m_aid0001.nc'
_output = 'outputs/mod15a2h_processed.nc'
_lookup = 'data/lai/MOD15A2H-006-FparLai-QC-lookup.csv'
_var = 'lai'
_datavar = 'Lai_500m'
_qcvar = 'FparLai_QC'
_fillvalue = 255
_discard_vars = ['FparExtra_QC', 'LaiStdDev_500m']
