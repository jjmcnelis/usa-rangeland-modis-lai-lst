...
Data Quality ....................................... 5
  ...
  MODIS Simplified Surface Energy Balance (SSEBop)
    Actual Evapotranspiration (ETa) .............. 5.7
...
1. Request Parameters
   ------------------
Request Name:   US_LAI-TerraAqua_June-August
Date Completed: 2018-12-01T02:08:33.750654
Id:             8838208d-4c94-41d0-a67c-de35b8b08097

Details:
    Input Vector Name:         CONUS
    Number of Vector Features: 1
    Start Date:                06-01
    End Date:                  08-31
    Year Range:                2000 - 2022
    Layers:
                               Lai_500m (MOD15A2H.006)
                               LaiStdDev_500m (MOD15A2H.006)
                               FparLai_QC (MOD15A2H.006)
                               FparLai_QC (MYD15A2H.006)
                               LaiStdDev_500m (MYD15A2H.006)
                               Lai_500m (MYD15A2H.006)
...
Version:
    This request was processed by AppEEARS version 2.13.1


2. Request File Information
   ------------------------
Supporting Files:
    US-LAI-TerraAqua-June-August-MOD15A2H-006-metadata.xml
    US-LAI-TerraAqua-June-August-MYD15A2H-006-metadata.xml
    US-LAI-TerraAqua-June-August-granule-list.txt
    US-LAI-TerraAqua-June-August-request.json
    MOD15A2H-006-FparLai-QC-lookup.csv
    MOD15A2H-006-FparExtra-QC-lookup.csv
    MYD15A2H-006-FparLai-QC-lookup.csv
    MYD15A2H-006-FparExtra-QC-lookup.csv
    MOD15A2H-006-FparLai-QC-Statistics-QA.csv
    MOD15A2H-006-FparExtra-QC-Statistics-QA.csv
    MYD15A2H-006-FparLai-QC-Statistics-QA.csv
    MYD15A2H-006-FparExtra-QC-Statistics-QA.csv
    MOD15A2H-006-Statistics.csv
    MYD15A2H-006-Statistics.csv

Data Files:
    Number of Extracted Data Files:     2
    Total Size of Extracted Data Files: 19,437.73 MB
...
regarding data collections/products and their associated QA data layers.
 ...
 5.7 SSEBop Actual Evapotranspiration (ETa)
     --------------------------------------
 ...
 5.8 eMODIS Smoothed Normalized Difference Vegetation Index (NDVI)
     -------------------------------------------------------------
...
9. Data Product Citations
   ----------------------
 Myneni, R., Knyazikhin, Y., Park, T. (2015). MOD15A2H MODIS/Terra Leaf Area Index/FPAR 8-Day L4 Global 500m SIN Grid V006. NASA EOSDIS Land Processes DAAC. doi: 10.5067/MODIS/MOD15A2H.006. Accessed December 1, 2018.
 
 Myneni, R., Knyazikhin, Y., Park, T. (2015). MYD15A2H MODIS/Aqua Leaf Area Index/FPAR 8-Day L4 Global 500m SIN Grid V006. NASA EOSDIS Land Processes DAAC. doi: 10.5067/MODIS/MYD15A2H.006. Accessed December 1, 2018.
 

10. Software Citation
   -----------------
 AppEEARS Team. (2018). Application for Extracting and Exploring Analysis Ready Samples (AppEEARS). Ver. 2.13. NASA EOSDIS Land Processes Distributed Active Archive Center (LP DAAC), USGS/Earth Resources Observation and Science (EROS) Center, Sioux Falls, South Dakota, USA. Accessed December 1, 2018. https://lpdaacsvc.cr.usgs.gov/appeears
