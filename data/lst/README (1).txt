...
1. Request Parameters
   ------------------
Request Name:   US_LST-Aqua_June-August
Date Completed: 2018-11-17T02:03:01.482000
Id:             794d702c-d26e-42b5-b5c7-0e5dd6f74150
...
2. Request File Information
   ------------------------
Supporting Files:
    US-LST-Aqua-June-August-MYD11A1-006-metadata.xml
    US-LST-Aqua-June-August-granule-list.txt
    US-LST-Aqua-June-August-request.json
    MYD11A1-006-QC-Day-lookup.csv
    MYD11A1-006-QC-Night-lookup.csv
    MYD11A1-006-QC-Day-Statistics-QA.csv
    MYD11A1-006-QC-Night-Statistics-QA.csv
    MYD11A1-006-Statistics.csv

Data Files:
    Number of Extracted Data Files:     1
    Total Size of Extracted Data Files: 20,894.82 MB
...
9. Data Product Citations
   ----------------------
 Wan, Z., Hook, S., Hulley, G. (2015). MYD11A1 MODIS/Aqua Land Surface Temperature/Emissivity Daily L3 Global 1km SIN Grid V006. NASA EOSDIS LP DAAC. doi: 10.5067/MODIS/MYD11A1.006. Accessed November 17, 2018.
 

10. Software Citation
   -----------------
 AppEEARS Team. (2018). Application for Extracting and Exploring Analysis Ready Samples (AppEEARS). Ver. 2.13. NASA EOSDIS Land Processes Distributed Active Archive Center (LP DAAC), USGS/Earth Resources Observation and Science (EROS) Center, Sioux Falls, South Dakota, USA. Accessed November 17, 2018. https://lpdaacsvc.cr.usgs.gov/appeears
